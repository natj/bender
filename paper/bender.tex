...
This results in an eccentricity of $\epsilon \approx 0.444$, $\beta = 0.013$, $q = -0.612$, roughly consistent with the values given by the FPS EoS as tabulated by \citealt{LP99}.
