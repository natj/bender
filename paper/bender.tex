...
\textbf{Exact shapes of line profiles for different neutron star spinning at $600~\mathrm{Hz}$.
...
Here we consider only rapidly spinning stars and hence set the spin to $600~\mathrm{Hz}$, close to the maximum value observed for any AMPs.
