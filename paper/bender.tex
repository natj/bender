...
The Full Width at Tenth Maximum and Full Width at Half Maximum of the smearing kernels are also reported for all \refedel{of the possible} viewing angles.
...
\ee
\refe{where $r$ is the radial coordinate defined so that the area of a sphere at coordinate time $t$ is $4\pi r^2$, and we set $u = 2M/r$.}
...
%respectively. 
\refe{where $\rb$ is the so-called isotropic radial coordinate and we set $\ub=M/\rb$.}
...
%\end{split}\end{align}
\be\label{eq:dSp}
dS' = \sqrt{\det m_{ab}} dx^a dx^b = \frac{e^{\zetab}}{B} \lgamma R^2 \sin\theta d\theta (d\phi - \Omega dt) 
\ee
Hence, \refe{the rotation} will result in a stretching of the area element by a factor of $\lgamma$.
...
\refe{The purpose of this is to clarify some common misunderstandings in the literature of how such a coordinate transformation can be done.}
