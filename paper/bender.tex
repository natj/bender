...
\caption{\label{fig:line_profiles}
    \refe{
Line profiles from a star with $R = 10~\mathrm{km}$, $M = 1.4~\Msun$, and a rotation frequency of $700$ Hz seen by an observer at an inclination $i = 20^{\circ}$. 
...
Effects like redshift, Doppler boosting and emission angle of the photon were discussed in a fully general relativistic manner in Sections \ref{sect:redshift_angle} and \ref{sect:emission}, hence also \refe{verifying} the previous ad-hoc special relativistic formulations \citep[see e.g.][]{PG03, PB06}.
