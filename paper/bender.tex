...
We, however, stress that the whole framework presented in this paper is general enough to be applied to any form of radiation originating from the visicinity of rotating compact objects. %, even though from here on we focus on the extreme case of AMPs.
