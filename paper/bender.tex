...
\vz = (\Omega - \wb) \Bb e^{-2\nub} \rb \sin\theta.
\ee
This is the so called zero angular momentum velocity as observed by non-rotating spectator at infinity.
...
The motion of the area also causes aberration in the angles between the normal to the surface and the initial photon direction as measured in the rest frame of area.
Because of this, the solid angle measured at inifnity $d\Omega_o$ is transformed with one extra Doppler-factor as compared to the static solid angle $d\Omega_s$ as
\be
d\Omega_o = \delta d\Omega_s.
\ee
