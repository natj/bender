...
for j in range(4):
    ...
    if j == 0:
        #fname = path_JP + 'sph/r12m16f1x5d50i60sph.txt'
        #fname2 = path_JP + 'sph/f1pbbr12m1.6d50i60x5.csv'
        fname = path_JP + 'sph/r12m16f1x5d50i60sphnodel.txt'
        fname2 = path_JP + 'sph/f1pbbr12m1.6d50i60x5.csv'
    if j == 1:
        #fname = path_JP + 'obl/r12m16f1x5d50i60obl3.txt'
        #fname2 = path_JP + 'obl/f1pbbr12m1.6d50i60x5.csv'
        fname = path_JP + 'obl/r12m16f1x5d50i60obl3nodel.txt'
        fname2 = path_JP + 'obl/f1pbbr12m1.6d50i60x5.csv'
    if j == 2:
        fname = path_JP + 'obl/r12m16f600x5d50i60obl3nodel.txt'
        fname2 = path_JP + 'obl/f600pbbr12m1.6d50i60x5_nodt.csv'
    if j == 3:
        #fname = path_JP + 'obl/r12m16f600x5d50i60obl3.txt'
        #fname2 = path_JP + 'obl/f600pbbr12m1.6d50i60x5.csv'
        fname = path_JP + 'sph/r12m16f600x5d50i60sph.txt'
        fname2 = path_JP + 'sph/f600pbbr12m1.6d50i60x5.csv'
