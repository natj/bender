...
#for j in [2,3]:
    ...
    if j == 0:
        fname = path3 + 'small-1-'
        fname2 = path3 + 'polar_f400_bb_r12_m1.6_d50_i60_x01.csv'
    if j == 1:
        fname = path3 + 'small-30-'
        fname2 = path3 + 'polar_f400_bb_r12_m1.6_d50_i60_x30.csv'
    if j == 2:
        fname = path3 + 'large-1-'
        fname2 = path3 + 'polar_f600_bb_r15_m1.6_d50_i60_x01.csv'
    if j == 3:
        fname = path3 + 'large-30-'
        fname2 = path3 + 'polar_f600_bb_r15_m1.6_d50_i60_x30.csv'
